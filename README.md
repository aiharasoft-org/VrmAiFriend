...
「ブラウザ開いて」「メモ帳起動して」「電卓」「ファインダー／エクスプローラー」「ターミナル」などと話すと、許可されたアプリだけを起動できます。「LINE」「Slack」「Discord」で各アプリ（インストール済みの場合）、「GitHub」「ノートを開いて」「Yahooニュースを開いて」で各サイトを開けます。
...
最新リリース（v0.9.5）の概要は [RELEASE_NOTES.md](RELEASE_NOTES.md) を参照してください。